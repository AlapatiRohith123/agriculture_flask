...
function run(){
    ...
    async function predict(position) {
        ...
        if(arr3[4]==1)
        {
            document.getElementById("output").innerHTML="Yield of "+arr[2].slice(5)+" is : "+data+" (Bales/Hectare)";
        }
        else
        {
            document.getElementById("output").innerHTML="Yield of "+arr[2].slice(5)+" is : "+data+" (Tonne/Hectare)";
        }
    }
